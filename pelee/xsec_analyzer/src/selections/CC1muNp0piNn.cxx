  ...
  void CC1muNp0piNn::define_constants() {
    define_FV("B_A",21.5,234.85,-95.0,95.0,21.5,966.8);
  ...
  bool CC1muNp0piNn::define_signal(AnalysisEvent* Event) {
    sig_inFV_ = point_inside_FV(this->FV("B_A"), Event->mc_nu_vx_, Event->mc_nu_vy_, Event->mc_nu_vz_);//this->true_FV()
  ...
  bool CC1muNp0piNn::selection(AnalysisEvent* Event) {
    ...
    sel_reco_vertex_in_FV_ = point_inside_FV(this->FV("B_A"), Event->nu_vx_, Event->nu_vy_, Event->nu_vz_);//ReturnRecoFV()
  ...
  int CC1muNp0piNn::categorize_event(AnalysisEvent* Event) {
    ...
    bool MCVertexInFV = point_inside_FV(this->FV("B_A"), Event->mc_nu_vx_, Event->mc_nu_vy_, Event->mc_nu_vz_);//ReturnTrueFV
    if ( !MCVertexInFV ) {
      return kOOFV;
    }
