...
namespace {
  ...
  template < typename T, typename S > TBranch* SetBranch(
  ...
  template < typename T, typename S >
    void SetBranch( TTree& out_tree, S var_name, T*&& rval_ptr )
  {
    T* address = rval_ptr;
    SetBranch( out_tree, var_name, address );
  }
  ...
  // accordingly
  template < typename T, typename S >
    void SetBranch( TTree& out_tree, S var_name, T& ref )
  {
    ...
    pair_iter != out_tree_maps_.end(); ++pair_iter )
  {
    ...
    for ( auto& tm_pair : tm ) {
      ...
      std::visit( [ &temp_tree, &br_name ]( auto& var_val )
        -> void { SetBranch( *temp_tree, br_name, var_val ); }, var );
    }
