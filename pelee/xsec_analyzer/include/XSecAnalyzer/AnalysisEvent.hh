...
public:
  ...
  // Event scores/variables needed for numuCC seliection
  int slice_orig_pass_id_ = BOGUS;
  float slice_orig_topo_score_ = BOGUS; float topological_score_ = BOGUS;
  int crtveto_ = BOGUS;
  double _closestNuCosmicDist_ = BOGUS; float cosmic_impact_parameter_ = BOGUS; //???
  ...
  float reco_nu_vtx_sce_x_ = BOGUS;
  float reco_nu_vtx_sce_y_ = BOGUS;
  float reco_nu_vtx_sce_z_ = BOGUS;
  ...
  int n_pfps_ = BOGUS_INT; int num_pf_particles_ = BOGUS_INT;
  ...
  MyPointer< std::vector<float> > trk_score_v_; //MyPointer< std::vector<float> > pfp_track_score_;
  ...
  MyPointer< std::vector<float> > shr_start_x_v_;
  MyPointer< std::vector<float> > shr_start_y_v_;
  MyPointer< std::vector<float> > shr_start_z_v_;
  MyPointer< std::vector<float> > shr_px_v_;
  MyPointer< std::vector<float> > shr_py_v_;
  MyPointer< std::vector<float> > shr_pz_v_;
  MyPointer< std::vector<float> > shower_start_distance_;

  // Track properties
  MyPointer< std::vector<float> > trk_llr_pid_score_v_;
  MyPointer< std::vector<float> > trk_sce_start_x_v_;
  MyPointer< std::vector<float> > trk_sce_start_y_v_;
  MyPointer< std::vector<float> > trk_sce_start_z_v_;
  MyPointer< std::vector<float> > trk_sce_end_x_v_;
  MyPointer< std::vector<float> > trk_sce_end_y_v_;
  MyPointer< std::vector<float> > trk_sce_end_z_v_;
  ...
  MyPointer< std::vector<std::string > > all_mc_process_;
  MyPointer< std::vector<std::string > > all_mc_end_process_;
