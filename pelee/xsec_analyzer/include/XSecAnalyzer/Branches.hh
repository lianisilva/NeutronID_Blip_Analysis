...
void set_event_branch_addresses(TTree& etree, AnalysisEvent& ev)
{
  ...
  // candidate)
  SetBranchAddress(etree, "nu_pdg", &ev.nu_pdg_ );//"slpdg"
  ...
  // Topological score
  SetBranchAddress(etree, "slice_orig_topo_score", &ev.slice_orig_topo_score_ );
  SetBranchAddress(etree, "crtveto", &ev.crtveto_ );
  SetBranchAddress(etree, "_closestNuCosmicDist", &ev._closestNuCosmicDist_ );
  ...
  SetBranchAddress(etree, "reco_nu_vtx_sce_x", &ev.reco_nu_vtx_sce_x_ );
  SetBranchAddress(etree, "reco_nu_vtx_sce_y", &ev.reco_nu_vtx_sce_y_ );
  SetBranchAddress(etree, "reco_nu_vtx_sce_z", &ev.reco_nu_vtx_sce_z_ );

  // Reconstructed object counts
  SetBranchAddress(etree, "n_pfps", &ev.n_pfps_ );
  ...
  set_object_input_branch_address( etree, "trk_score_v", ev.trk_score_v_ );

  set_object_input_branch_address( etree, "pfp_generation_v", ev.pfp_generation_ );
  set_object_input_branch_address( etree, "pfp_trk_daughters_v", ev.pfp_trk_daughters_count_ );
  set_object_input_branch_address( etree, "pfp_shr_daughters_v", ev.pfp_shr_daughters_count_ );
  ...
  bool has_shower_branches = ( etree.GetBranch("shr_start_x_v") != nullptr );
  if ( has_shower_branches ) {
    set_object_input_branch_address( etree, "shr_start_x_v", ev.shr_start_x_v_ );
    set_object_input_branch_address( etree, "shr_start_y_v", ev.shr_start_y_v_ );
    set_object_input_branch_address( etree, "shr_start_z_v", ev.shr_start_z_v_ );
    set_object_input_branch_address( etree, "shr_px_v", ev.shr_px_v_ );
    set_object_input_branch_address( etree, "shr_py_v", ev.shr_py_v_ );
    set_object_input_branch_address( etree, "shr_pz_v", ev.shr_pz_v_ );
    ...
    // convenience)
    set_object_input_branch_address( etree, "shr_dist_v", ev.shower_start_distance_ );
  }
  else {
    ...
    // output TTree
    ev.shr_start_x_v_.reset( nullptr );
    ev.shr_start_y_v_.reset( nullptr );
    ev.shr_start_z_v_.reset( nullptr );
    ev.shr_px_v_.reset( nullptr );
    ev.shr_py_v_.reset( nullptr );
    ev.shr_pz_v_.reset( nullptr );
  ...
  // Track properties
  set_object_input_branch_address( etree, "trk_sce_start_x_v", ev.trk_sce_start_x_v_ );
  set_object_input_branch_address( etree, "trk_sce_start_y_v", ev.trk_sce_start_y_v_ );
  set_object_input_branch_address( etree, "trk_sce_start_z_v", ev.trk_sce_start_z_v_ );
  ...
  // convenience)
  set_object_input_branch_address( etree, "trk_sce_end_x_v", ev.trk_sce_end_x_v_ );
  set_object_input_branch_address( etree, "trk_sce_end_y_v", ev.trk_sce_end_y_v_ );
  set_object_input_branch_address( etree, "trk_sce_end_z_v", ev.trk_sce_end_z_v_ );

  set_object_input_branch_address( etree, "trk_distance_v", ev.track_start_distance_ );
  ...
  set_object_input_branch_address( etree, "trk_energy_proton_v", ev.track_kinetic_energy_p_ );
  set_object_input_branch_address( etree, "trk_range_muon_mom_v", ev.track_range_mom_mu_ );
  set_object_input_branch_address( etree, "trk_mcs_muon_mom_v", ev.track_mcs_mom_mu_ );
  ...
  set_object_input_branch_address( etree, "trk_llr_pid_u_v", ev.track_llr_pid_U_ );
  set_object_input_branch_address( etree, "trk_llr_pid_v_v", ev.track_llr_pid_V_ );
  set_object_input_branch_address( etree, "trk_llr_pid_y_v", ev.track_llr_pid_Y_ );

  set_object_input_branch_address( etree, "trk_llr_pid_score_v", ev.track_llr_pid_score_ );
  ...
  bool create = false)
{
  ...
  set_output_branch_address( out_tree, "slice_orig_pass_id", &ev.slice_orig_pass_id_, create,
    "slice_orig_pass_id/I" );
  ...
  set_object_output_branch_address< std::vector<int> >( out_tree, "blip_trkid",
    ev.blip_trkid_, create );//, "blip_trkid" );

  // Cosmic rejection parameters for numu CC inclusive selection
  set_output_branch_address( out_tree, "slice_orig_topo_score",
    &ev.slice_orig_topo_score_, create, "slice_orig_topo_score/F" );

  set_output_branch_address( out_tree, "crtveto",
    &ev.crtveto_, create, "crtveto/I" );

  set_output_branch_address( out_tree, "_closestNuCosmicDist",
    &ev._closestNuCosmicDist_, create, "_closestNuCosmicDist/D" );

  // Reconstructed neutrino vertex position
  set_output_branch_address( out_tree, "reco_nu_vtx_sce_x",
    &ev.reco_nu_vtx_sce_x_, create, "reco_nu_vtx_sce_x/F" );

  set_output_branch_address( out_tree, "reco_nu_vtx_sce_y",
    &ev.reco_nu_vtx_sce_y_, create, "reco_nu_vtx_sce_y/F" );

  set_output_branch_address( out_tree, "reco_nu_vtx_sce_z",
    &ev.reco_nu_vtx_sce_z_, create, "reco_nu_vtx_sce_z/F" );

  // MC truth information for the neutrino
  set_output_branch_address( out_tree, "mc_nu_pdg", &ev.mc_nu_pdg_,   // isn't this nu_pdg??
    create, "mc_nu_pdg/I" );
  ...
  set_object_output_branch_address< std::vector<float> >( out_tree,
    "trk_score_v", ev.trk_score_v_, create );
  ...
  if ( ev.shr_start_x_v_ ) {
    set_object_output_branch_address< std::vector<float> >( out_tree,
      "shr_start_x_v", ev.shr_start_x_v_, create );

    set_object_output_branch_address< std::vector<float> >( out_tree,
      "shr_start_y_v", ev.shr_start_y_v_, create );

    set_object_output_branch_address< std::vector<float> >( out_tree,
      "shr_start_z_v", ev.shr_start_z_v_, create );
  ...
  set_object_output_branch_address< std::vector<float> >( out_tree,
    "trk_sce_start_x_v", ev.trk_sce_start_x_v_, create );

  set_object_output_branch_address< std::vector<float> >( out_tree,
    "trk_sce_start_y_v", ev.trk_sce_start_y_v_, create );

  set_object_output_branch_address< std::vector<float> >( out_tree,
    "trk_sce_start_z_v", ev.trk_sce_start_z_v_, create );
  ...
  set_object_output_branch_address< std::vector<float> >( out_tree,
    "trk_sce_end_x_v", ev.trk_sce_end_x_v_, create );

  set_object_output_branch_address< std::vector<float> >( out_tree,
    "trk_sce_end_y_v", ev.trk_sce_end_y_v_, create );

  set_object_output_branch_address< std::vector<float> >( out_tree,
    "trk_sce_end_z_v", ev.trk_sce_end_z_v_, create );
