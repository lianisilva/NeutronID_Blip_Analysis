...
ROOT_FILES_LIST="${1:-root_files.txt}"   # Default to root_files.txt if not provided
PLOT_CONFIG="${2:-plot_configs.txt}"   # Default to plot_configs.txt
...
root -l -b -q "multi_histograms_General.C(\"$FILE1\", \"$FILE2\", \"$FILE3\", \"$FILE4\", \"$PLOT_CONFIG\")"

echo "All plots saved to all_plots_output.root"
